...
9) 🧭 Общий вывод — 10 развернутых пунктов с объяснениями «куда всё идёт сейчас».
...
def generate_report(kind="daily"):
    ...
    data = {
        ...
        "temperature": 0.3,
        "messages": [
            {"role": "system", "content": "Ты — лучший в мире аналитик, отвечай фактами, структурно и интересно."},
